...
# Disable concurrent DB ops by default (can be overridden by env at runtime)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--query-limit", type=int, default=0, help="Maximum number of queries to evaluate (<=0 means all loaded items).")
    parser.add_argument(
        "--mode",
        default="all",
